...
description: 'Barcode Quality Metrics (BQM) are used to verify the quality of your printed barcode, so you know you can count on it to perform as expected in its intended...'
