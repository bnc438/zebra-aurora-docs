...
description: Determine the IP address of the host computer where the FTP resides.
...
---
1. Download babyftp (free FTP solution) from [pablosoftwaresolutions.com/html/baby_ftp_server.html](https://www.pablosoftwaresolutions.com/html/baby_ftp_server.html). Babyftp does not have an option for credentialed access (SFTP).
...
1. In Aurora Focus, navigate to the **Connect** chevron, then **Save Image**.
2. Select **FTP** under **Save Location**.
