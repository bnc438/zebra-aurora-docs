...
description: The device supports different use cases with single shot, level continuous,
  series (burst), periodic single shot, continuous, and presentation trigger modes.
